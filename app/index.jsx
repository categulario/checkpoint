        ...
        <div className="navbar navbar-default navbar-fixed-top">
          <div className="container">
            <div className="navbar-header">
              <a href="../" className="navbar-brand">Fleety</a>
            ...
            <div className="navbar-collapse collapse" id="navbar-main">
              <ul className="nav navbar-nav">
                ...
                <li className="dropdown">
                  <a className="dropdown-toggle" data-toggle="dropdown" href="#" id="download">Default <span className="caret"></span></a>
              ...
              <div className="col-lg-7">
                ...
                <div style={{ marginBottom: "15px" }}>
                  <div className="btn-toolbar bs-component" style={{ margin: 0 }}>
                    ...
                    <div className="btn-group">
                      <a href="#" className="btn btn-primary">Primary</a>
                      <a href="#" className="btn btn-primary dropdown-toggle" data-toggle="dropdown"><span className="caret"></span></a>
                      <ul className="dropdown-menu">
                        <li><a href="#">Action</a></li>
                        <li><a href="#">Another action</a></li>
                        <li><a href="#">Something else here</a></li>
                    ...
                    <div className="btn-group">
                      <a href="#" className="btn btn-success">Success</a>
                      <a href="#" className="btn btn-success dropdown-toggle" data-toggle="dropdown"><span className="caret"></span></a>
                      <ul className="dropdown-menu">
                        <li><a href="#">Action</a></li>
                        <li><a href="#">Another action</a></li>
                        <li><a href="#">Something else here</a></li>
                    ...
                    <div className="btn-group">
                      <a href="#" className="btn btn-info">Info</a>
                      <a href="#" className="btn btn-info dropdown-toggle" data-toggle="dropdown"><span className="caret"></span></a>
                      <ul className="dropdown-menu">
                        <li><a href="#">Action</a></li>
                        <li><a href="#">Another action</a></li>
                        <li><a href="#">Something else here</a></li>
                    ...
                    <div className="btn-group">
                      <a href="#" className="btn btn-warning">Warning</a>
                      <a href="#" className="btn btn-warning dropdown-toggle" data-toggle="dropdown"><span className="caret"></span></a>
                      <ul className="dropdown-menu">
                        <li><a href="#">Action</a></li>
                        <li><a href="#">Another action</a></li>
                        <li><a href="#">Something else here</a></li>
              ...
              <div className="col-lg-4 col-lg-offset-1">
                  <form className="bs-component">
                    <div className="form-group">
                      ...
                      <input className="form-control" id="focusedInput" type="text" value="This is focused..." />
                    </div>
                    <div className="form-group">
              ...
              <div className="col-lg-4">
                ...
                <div className="bs-component">
                  <ul className="nav nav-pills">
                    ...
                    <li><a href="#">Profile <span className="badge"></span></a></li>
          ...
          <footer>
            <div className="row">
              <div className="col-lg-12">
                ...
                <p>Made by <a href="http://thomaspark.co" rel="nofollow">Thomas Park</a>. Contact him at <a href="/cdn-cgi/l/email-protection#89fde1e6e4e8fac9ebe6e6fdfafee8fdeae1a7eae6e4"><span className="__cf_email__" data-cfemail="7105191e1c100231131e1e050206100512195f121e1c">[email&#160;protected]</span></a>.</p>
